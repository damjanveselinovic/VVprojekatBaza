...
public class FormaKnjiga extends javax.swing.JDialog {
    ...
    public FormaKnjiga(java.awt.Frame parent, boolean modal, Knjiga knjigaZaIzmenu){
        ...
        if(knjigaZaIzmenu!=null){
            ...
            jTextFieldNazivKnjige.setText(knjigaZaIzmenu.getIme());
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(jTextFieldGodIzdanja, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 53, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(49, 49, 49)
                            .addComponent(jTextFieldNazivKnjige, javax.swing.GroupLayout.PREFERRED_SIZE, 180, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(jTextFieldISBN, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
    ...
    private void jButtonDodajActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDodajActionPerformed
        ...
        String naziv=jTextFieldNazivKnjige.getText();
        if (naziv==null || naziv.isEmpty() || naziv.trim().length()<3){
            JOptionPane.showMessageDialog(this, "Knjiga ne zadovoljava standarde po nazivu", "Greska", JOptionPane.ERROR_MESSAGE);
            return;
        }
        ...
        try{ 
            ...
            if(godIzdanja <1800 || godIzdanja>2024){
                JOptionPane.showMessageDialog(this, "Knjiga ne zadovoljava standarde po godini", "Greska", JOptionPane.ERROR_MESSAGE);
            }
        }
        ...
        Kontroler.getInstance().dodajKnjigu(novaKnjiga);
